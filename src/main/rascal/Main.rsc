...
Projects projects = {
    ...
    <"rascal-lsp", project(|https://github.com/usethesource/rascal-language-servers.git|, {"rascal"}, branch="fix/type-errors-in-integration-tests", srcs=["src/main/rascal/library"], subdir="rascal-lsp")>
};
