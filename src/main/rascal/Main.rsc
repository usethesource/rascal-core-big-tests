...
Projects projects = {
    <"rascal", project(|https://github.com/usethesource/rascal.git|, {}, srcs = ["src/org/rascalmpl/library"], branch="remove-tree-loc-annotation", ignores={"experiments", "resource", "lang/rascal/tests", "lang/rascal/syntax/tests", "lang/rascal/grammar/tests"}, parallel = true, parallelPreCheck = {"src/org/rascalmpl/library/Prelude.rsc"})>,
    ...
    <"typepal", project(|https://github.com/usethesource/typepal.git|, {"rascal"}, branch="fix/remove-annotations", ignores={"examples"})>,
