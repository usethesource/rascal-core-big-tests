...
Projects projects = {
    ...
    <"rascal-all", project(|https://github.com/usethesource/rascal.git|, {}, parallel = false, parallelPreCheck = {"src/org/rascalmpl/library/Prelude.rsc", "src/org/rascalmpl/compiler/lang/rascalcore/check/CheckerCommon.rsc"})>,
